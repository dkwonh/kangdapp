 ...
 */
public class SchoolAdministration2 extends Fragment {
    ...
    protected class JsoupAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...params){
            try{
                Document doc = Jsoup.connect("http://home.kangwon.ac.kr/main/html/campuslife/administration_02.jsp").maxBodySize(0).timeout(15000).get();
