 ...
 */
public class SchoolAdministration5 extends Fragment {
    ...
    protected class JsoupAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...params){
            try{
                Document doc = Jsoup.connect("http://home.kangwon.ac.kr/main/html/campuslife/administration_05.jsp").maxBodySize(0).timeout(15000).get();
                ...
                string = string.substring(0, string.indexOf("<a href") - 24) + string.substring(string.indexOf("GO") + 40);
