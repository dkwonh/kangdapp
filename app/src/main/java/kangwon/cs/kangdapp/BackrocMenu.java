...
public class BackrocMenu extends AppCompatActivity {
    int getInt= 0;
    ...
    private BackrockParser backrockParser;
    TPABackroc pagerAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        backrockParser = new BackrockParser(day);
        //day = intent.getStringArrayListExtra("detail");
    ...
    public class BackrockParser {
        String TAG = "TAG";
        String url = "http://knucoop.or.kr/weekly_menu_02.asp";
        ArrayList<String> detail;
        soupAsyncTask jsoupAsyncTask = new soupAsyncTask();
        BackrockParser(ArrayList<String> detail){
            this.detail = detail;
        ...
        class soupAsyncTask extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void unused){
                try {
                    ...
                    pagerAdapter = new TPABackroc(getSupportFragmentManager(), tabLayout.getTabCount(), day);
