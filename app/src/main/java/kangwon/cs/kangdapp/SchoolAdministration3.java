 ...
 */
public class SchoolAdministration3 extends Fragment {
    ...
    protected class JsoupAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...params){
            try{
                Document doc = Jsoup.connect("http://home.kangwon.ac.kr/main/html/campuslife/administration_03.jsp").maxBodySize(0).timeout(15000).get();
