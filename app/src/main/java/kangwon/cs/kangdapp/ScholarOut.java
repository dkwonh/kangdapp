 ...
 */
public class ScholarOut extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        View v = inflater.inflate(R.layout.scholar_out, container, false);
    ...
    protected class JsoupAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void...params){
            try{
                Document doc = Jsoup.connect("http://home.kangwon.ac.kr/main/html/campuslife/scholarship_01.jsp").maxBodySize(0).timeout(15000).get();
                //Log.d(TAG,"doc size : " + doc);
                Elements links = doc.select("html > body > div#center_full > div#content > div");
